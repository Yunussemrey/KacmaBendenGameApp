...
public class Oyun10Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RewardedAd.load(requireActivity(), "ca-app-pub-3475820063501035/5852049051",
        ...
        binding.stop10.setOnClickListener(v -> {
           ...
           action.stopRunnable();
            ...
            btnPozitif.setOnClickListener(v1 -> {
                resumeTimer();
                action.karakterGizle(imageArray,400,25);
                alertDialog.dismiss();
            });
    ...
    private void sonSkor(){
        ...
        if (sonPuan>=150){
            ...
            mesaj.setText("Tebrikler! 1. Level'i bitirdiniz. 2. Level için kısa bi süre sabrınızı rica ediyorum");
            btnPozitif.setText("Yeniden Başla");
            ...
            baslik.setText("Bölüm Sonu! Puanınız: "+sonPuan);
            mesaj.setText("Maalesef! Puanınız bu bölümü bitirmek için yeterli değil");
        ...
        if (rewardedAd != null) {
            rewardedAd.show(requireActivity(), new OnUserEarnedRewardListener() {
                ...
                public void onUserEarnedReward(@NonNull RewardItem rewardItem) {
                    ...
                    ft.replace(R.id.fragmentContainerView, new Oyun10Fragment()).commit();
                }
            });
    ...
    public void onPause() {
        ...
        ft.remove(Oyun10Fragment.this).commit();
        Intent musicIntent = new Intent(getActivity(), Music2Service.class);
        getActivity().stopService(musicIntent);
    }
    ...
    public void onResume() {
        ...
        baslik.setText("Son Bölüm");
        mesaj.setText("Buralar iyice mayın tarlasına döndü. 1. Level'i tamamlamak için 150 puana ulaşman gerek");
        oyna.setText("Oyna");
